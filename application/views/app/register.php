        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
            ...
            <div class="register-form mt-5 px-4">
              <form action="<?= base_url('app_control/signup')?>" method="post">
                <div class="form-group text-start mb-4"><span>Name</span>
                  <label for="email"><i class="lni lni-user"></i></label>
                  <input class="form-control" id="name" name="name" required type="text" placeholder="User Name">
                </div>
                
                <div class="form-group text-start mb-4"><span>Username</span>
                  <label for="email"><i class="lni lni-user"></i></label>
                  <input class="form-control" id="username" name="username" required type="text" placeholder="User Name">
                </div>
                <div class="form-group text-start mb-4"><span>Email</span>
                  <label for="email"><i class="lni lni-envelope"></i></label>
                  <input class="form-control" id="email" name="email" required type="email" placeholder="help@example.com">
                </div>
                 <div class="form-group text-start mb-4"><span>Contact No.</span>
                  <label for="email"><i class="lni lni-phone"></i></label>
                  <input class="form-control" id="contact" name="contact" required type="text" placeholder="Contact No.">
                </div>
                <div class="form-group text-start mb-4"><span>Password</span>
                  <label for="email"><i class="lni lni-lock"></i></label>
                  <input class="input-psswd form-control" name="password" required id="registerPassword" type="password" placeholder="Password">
                </div>
                 <div class="form-group text-start form-check mb-4">
                    <input class="form-check-input" id="registration" name="registration" type="checkbox">
