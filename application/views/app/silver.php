<div class="page-content-wrapper">
      <div class="product-slide-wrapper">
        ...
        <div class="product-slides owl-carousel">
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/025.png');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/031.jpg');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/030.jpg');?>)"></div>
        </div>
      ...
      <div class="product-description pb-3">
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container d-flex justify-content-between">
            <div class="p-title-price">
              <h6 class="mb-1">Silver</h6>
              <?php 
                if(!empty($list)){
                  foreach ($list as $key => $value) {
                     if($value['stack_name']=='Silver Stake' || $value['stack_name']=='Silver'){
          ...
          <div class="container">
            <form class="cart-form" action="#" method="">
              <div class="order-plus-minus d-flex align-items-center">
                <marquee><span style="color:red;"><strong>Total Share Issue:</strong><?php echo $list[0]['business'];?></span>&nbsp;&nbsp;&nbsp;<span style="color:Green;"><strong>Left Share Issue:</strong>1200</span>&nbsp;&nbsp;&nbsp;</marquee>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="cart-form-wrapper bg-white mb-3 py-3">
          <div class="container">
            <form class="cart-form" action="<?php echo base_url('app_control/create_share')?>" method="POST">
              ...
              ?>
               <input type="hidden" name="stack_name" value="Silver">
              <button class="btn btn-warning ms-3" type="submit">Buy Now</button>
            </form>
          </div>
        </div>
        ...
        <div class="p-specification bg-white mb-3 py-3">
          <div class="container">
            ...
            <p>In the international market, gold was trading 0.24 per cent up at USD 1,857 per ounce. Silver was trading marginally up at USD 23.52 per ounce </p>
            <ul class="mb-3 ps-3">
              <li><i class="lni lni-checkmark-circle"> </i> 100% Good Reviews</li>
              <li><i class="lni lni-checkmark-circle"> </i>  In 1 Day & 1 Share Returns 221/- </li>
              <li> <i class="lni lni-checkmark-circle"> </i> Warranty not Aplicable</li>
              <li> <i class="lni lni-checkmark-circle"> </i> 100% Garuntee Share</li>
            </ul>
            <p class="mb-0">Gold futures on MCX were trading down by 0.13 per cent or Rs 62 at Rs 49,323 per 10 grams. Silver futures eased more than 0.16 per cent or Rs 103 to Rs 62,886 per kg.</p>
          </div>
        </div>
        <!-- Product Video -->
