<div class="page-content-wrapper">
      <div class="product-slide-wrapper">
        ...
        <div class="product-slides owl-carousel">
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/035.jpeg');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/036.jpg');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/037.jpeg');?>)"></div>
        </div>
         ...
         <div class="cart-form-wrapper bg-white mb-3 py-3">
          <div class="container">
            <form class="cart-form" action="#" method="">
              <div class="order-plus-minus d-flex align-items-center">
                <marquee><span style="color:red;"><strong>Total Share:</strong>280</span>&nbsp;&nbsp;&nbsp;<span style="color:Green;"><strong>Left Share:</strong>220</span>&nbsp;&nbsp;&nbsp;</marquee>
              </div>
            </form>
          </div>
        </div>
