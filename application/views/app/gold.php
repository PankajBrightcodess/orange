<div class="page-content-wrapper">
      <div class="product-slide-wrapper">
        ...
        <div class="product-slides owl-carousel">
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/032.jpeg');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/032.jpg');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/033.jpg');?>)"></div>
        </div>
               ...
               <?php 
                if(!empty($list)){
                  foreach ($list as $key => $value) {
                     if($value['stack_name']=='Gold Stake' || $value['stack_name']=='Gold'){
          ...
          <div class="container">
            <form class="cart-form" action="<?php echo base_url('app_control/create_share')?>" method="POST">
              ...
              <?php 
                if(!empty($list)){
                    foreach ($list as $key => $value) {
                       if($value['stack_name']=='Gold Stake' || $value['stack_name']=='Gold Stake'){
                       ?><input type="hidden" value="<?php echo $value['invest'];?>" name="amount"><?php
                    }
                  }
                }
              ?>
               <input type="hidden" name="stack_name" value="Gold">
         ...
         <div class="cart-form-wrapper bg-white mb-3 py-3">
          <div class="container">
            <form class="cart-form" action="#" method="">
              <div class="order-plus-minus d-flex align-items-center">
                <marquee><span style="color:red;"><strong>Total Share:</strong>625</span>&nbsp;&nbsp;&nbsp;<span style="color:Green;"><strong>Left Share:</strong>375</span>&nbsp;&nbsp;&nbsp;</marquee>
              </div>
            </form>
          </div>
        </div>
