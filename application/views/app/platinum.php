<div class="page-content-wrapper">
      <div class="product-slide-wrapper">
        ...
        <div class="product-slides owl-carousel">
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/038.png');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/067.jpg');?>)"></div>
          <!-- Single Hero Slide-->
          <div class="single-product-slide" style="background-image: url(<?= base_url('assets/app_assets/img/product/040.png');?>)"></div>
        </div>
         ...
         <div class="cart-form-wrapper bg-white mb-3 py-3">
          <div class="container">
            <form class="cart-form" action="#" method="">
              <div class="order-plus-minus d-flex align-items-center">
                <marquee><span style="color:red;"><strong>Total Amount:</strong>500000/-</span>&nbsp;&nbsp;&nbsp;<span style="color:Green;"><strong>Left Amount:</strong>20000/-</span>&nbsp;&nbsp;&nbsp;</marquee>
              </div>
            </form>
          </div>
        </div>
