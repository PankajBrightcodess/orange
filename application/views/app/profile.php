        ...
        <div class="profile-wrapper-area py-3">
          ...
          <div class="card user-info-card">
            <div class="card-body p-4 d-flex align-items-center">
              <div class="user-profile me-3"><img src="<?= base_url('assets/app_assets/img/bg-img/8.jpg')?>" alt=""></div>
              <div class="user-info">
                <p class="mb-0 text-white">@designing-world</p>
                <h5 class="mb-0">Pankaj Tiwari</h5>
              </div>
            </div>
          </div>
          <!-- User Meta Data-->
          <div class="card user-data-card">
            <div class="card-body">
              <div class="single-profile-data d-flex align-items-center justify-content-between">
                ...
                <div class="data-content">pmt@gmail.com</div>
              </div>
              <div class="single-profile-data d-flex align-items-center justify-content-between">
              ...
              <div class="single-profile-data d-flex align-items-center justify-content-between">
                ...
                <div class="data-content"><a class="btn btn-danger btn-sm" href="<?= base_url('app_control/cart')?>">View</a></div>
              </div>
              <!-- Edit Profile-->
              <div class="edit-profile-btn mt-3"><a class="btn btn-info w-100" href="#"><i class="lni lni-pencil me-2"></i>Edit Profile</a></div>
            </div>
          </div>
        </div>
      </div>
