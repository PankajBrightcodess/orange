                                     ...
                                     <?php if(!empty($userlist)){ 
                                            ...
                                            foreach ($userlist as $key => $row) {
                                               ...
                                               <tr>
                                                ...
                                                <a href='<?php echo base_url("admin/delete_user/?id=$row[id]");?>'><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button></a>
                                                <button type="button" class="btn btn-success btn-xs updt" data-id="<?php echo $row['id'];?>" data-name="<?php echo $row['name'];?>" data-username="<?php echo $row['username'];?>" data-email="<?php echo $row['email'];?>" data-contact="<?php echo $row['contact'];?>" data-password="<?php echo $row['password'];?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-edit"></i></button>
                                                </span></td>
                                            </tr>
                                         <?php
                                            }
